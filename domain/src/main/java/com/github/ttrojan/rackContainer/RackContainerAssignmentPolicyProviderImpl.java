...
public class RackContainerAssignmentPolicyProviderImpl implements RackContainerAssignmentPolicyProvider {

    private final Map<RackContainerAssignmentPolicyType, RackContainerAssignmentPolicy> policyMap;

    public RackContainerAssignmentPolicyProviderImpl(List<RackContainerAssignmentPolicy> assignmentPolicies) {
